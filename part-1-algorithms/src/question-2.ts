 ...
 */
function countCharacterFrequency(text: string) {
   const objOutput: Record<string, number> = {};

   if (typeof text !== "string") return objOutput;
...
console.log(countCharacterFrequency(null as any));
// Expected: {}
